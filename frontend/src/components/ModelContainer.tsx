...
const ModelContainer = () => {
    return (
        <div className="flex flex-col  justify-center  w-[100%]  min-h-screen dark:bg-gray-900 p-4">
            ...
            <h1 className=" text-4xl font-bold dark:text-white text-gray-700">404 Page Not Found😇</h1>
            <Link href="/">
